      ...
      <div className="hidden md:flex md:w-1/2 bg-primary p-12 items-center justify-center">
        <div className="max-w-md text-white">
          ...
          <p className="text-lg mb-8 text-primary-foreground/90">
            Experimente todas as funcionalidades da Tavrus por 14 dias, sem compromisso.
          ...
          <CardHeader className="space-y-4">
            <div className="flex justify-center mb-4">
              <Link href="/" className="flex items-center">
                <Image style={{ width: 150, height: 100, marginBottom: -40}} src={logo} alt="Tavrus Logo" className="h-6" />
              </Link>
            </div>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-6">
                ...
                >
                  {isSubmitting ? "Processando..." : "Criar minha conta grátis"}
                </Button>
              </div>
            </form>
          </CardContent>
